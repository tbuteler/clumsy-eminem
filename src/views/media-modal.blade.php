            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="{{ !$media->isEmpty() ? 'active' : 'hidden' }}">
                        <a class="current-a" href="#{{ $id }}-current" role="tab" data-toggle="pill">Current</a>
                    </li>
                    <li class="{{ !$media->isEmpty() ? '' : 'active' }}">
                        <a class="upload-a" href="#{{ $id }}-upload" role="tab" data-toggle="pill">Upload</a>
                    </li>
                    {{--
                    <li>
                        <a class="library-a" href="#{{ $id }}-library" role="tab" data-toggle="pill">Library</a>
                    </li>
                    --}}
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade {{ !$media->isEmpty() ? '' : 'in active' }}" id="{{ $id }}-upload">
                        ...
                        <div class="drag-and-drop">
                            <div class="drag-text">
                                <h3 class="drag-title">Drag and drop media here</h3>
                                <span class="separator">or</span>
                                <button class="btn btn-default">Select files</button>
                            </div>
                            <div class="drop-text">
                                <h3 class="drag-title">Drop media here</h3>
                            </div>
                        </div>
